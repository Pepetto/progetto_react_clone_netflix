    ...
    return(
        <div>
            <footer class="container-fluid relative no-overflow mt-5">
                ...
                <img src="/img/logo-aulab-square-black.png" alt="Aulab Srl" class="logo-xl img-fluid transparent absolute d-none d-xl-block" width="25%"/>
                ...
                <section class="row justify-content-around py-4">
                    ...
                    <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <h3 class="text-yellow bold mb-0" itemprop="name">Aulab Srl</h3>
                        ...
                        <li><a href="https://aulab.it/contatti" class=""><i class="fa fa-envelope mr-2 text-yellow" aria-hidden="true"></i>Contattaci</a></li>
                    ...
                    <div class="col-12 col-lg-3 mb-4 mb-lg-0">
                        ...
                        <ul class="bold list-unstyled mb-4">
                            <li class="mb-2"><a href="https://aulab.it" class="">Hackademy Full-time</a></li>
                            <li class="mb-2"><a href="https://aulab.it/hackademy-parttime" class="">Hackademy Part-time</a></li>
                            <li class="mb-2"><a href="https://aulab.it/hackweekend" class="">Hack-Weekend Front-end</a></li>
